                    ...
                    <div class="container p-5">
                        <div class="carousel-inner mt-3">
                            <div class="carousel-item active">
                                ...
                                <a href="/adminproduct/tambah" type="button" class="btn btn-info mb-3">Tambah Produk</a>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php $i = 1; ?>
                                        <?php foreach ($adminproduct as $p) : ?>
                                            <tr>
                                                <th scope="row"><?= $i++; ?></th>
                                                <td><img src="/img/product/<?= $p['gambar']; ?>" alt="" class="gambar"></td>
                                                <td><?= $p['nama_produk']; ?></td>
                                                <td><a href="/adminproduct/<?= $p['slug']; ?>" type="button" class="btn btn-success">Lihat</a></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
